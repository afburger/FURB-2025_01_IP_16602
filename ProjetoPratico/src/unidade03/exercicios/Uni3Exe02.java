 ...
 * 
 * Ao usar float pode retornar 113,520004 no exemplo acima.
 * Isso ocorre porque:
 * 
 * 129.00000 e 15.48000 não podem ser representados exatamente como float devido à conversão para binário.
 * Ao realizar a subtração, essas pequenas imprecisões se acumulam e resultam em um valor ligeiramente diferente.
 * 
 */
